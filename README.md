...
[docs/deployment.md](docs/deployment.md) ([中文](docs/deployment.zh.md)) covers
the rest: getting a proxy past `sudo`, choosing where the bundle lands,
installing with no route to GitHub, and the errors that do not say what they
mean.
